...
* [Staging workspace registered model](https://westus.azuredatabricks.net/ml/models/staging-my_mlops_project-model)
* [Prod workspace registered model](https://adb-xxxx.xx.azuredatabricks.net/ml/models/prod-my_mlops_project-model). 
